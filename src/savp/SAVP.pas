...
var
     AutoInformIndx:              Byte;	     // ������� ������� ����-�����������
     InformIndx:                  Integer;      // ������� ������� ��������� �����������
     TotalInfoFiles:              Integer;      // ����� ������� ��������� �����������
     TotalAutoInfoFiles:          Integer;
     TotalServiceFiles:           Integer;
     AutoInformDoorFlag:          Boolean;      // ���� ������� ����������� �� �������� ������ ��� V=0
     ...
     SAVP_EK_NewSystem:           Boolean;      // ���������� ��� �����������, �����-�� ������� �� �������� (*.TWS, *.txt)
     ...
     SAVPEFilePrefiks:            String;       // ������� ��� ��� ������ ("SAVPE_", "UPU_")
     isOn150mOnSvetofor:          Integer;
     isOn250mOnSvetofor:          Integer;
     LocomotiveBreaked:           Boolean = True; // ��� ������, ���������� ����������
   ...
   //try
      With FormMain do begin
         wIni := TIniFile.Create(fileDir);
              Memo4.Text := CP1251ToUTF8(wIni.ReadString('DESCRIPTION', 'Text', '� ������ �� �������� �����������! ���������� � ������!'));
         wIni.Free;
     ...
     if FileExists(fileDir) then begin
	   ...
	   Memo7.Lines.Clear;
           if ComboBox2.ItemIndex<>0 then
              Memo7.Text := CP1251ToUTF8(wIni.ReadString('DESCRIPTION', 'Text', '� ������ �� �������� �����������! ���������� � ������!'))
           else Memo7.Text := '����� - ��� ��';
           wIni.Free;
           // ������� ���� �� ����
           clearSAVPBaseData();
